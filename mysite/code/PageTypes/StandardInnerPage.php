...
class StandardInnerPage extends Page {
	...
	public function getCMSFields(){
	    ...
	    $this->beforeUpdateCMSFields(function(FieldList $fields) {
			...
			//	$fields->dataFieldByName('Content')->setTitle('Content (Try to use content blocks rather than the content field)');

		});

		$fields = parent::getCMSFields();
		
		$fields->addFieldToTab('Root.PageHeader', UploadField::create('HeaderImage', 'Header Image'));
